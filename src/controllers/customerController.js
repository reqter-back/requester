...
exports.login = [
  (req, res, next) => {
    ...
    if (!errors.isEmpty()) {
      ...
      broker
        .sendRPCMessage(
          { body: req.body, headers: req.headers, method: "POST", query: {} },
          "token"
        )
        .then(result => {
          var obj = JSON.parse(result.toString("utf8"));
              ...
              if (!obj.data.authenticated) {
                ...
                if (process.env.NODE_ENV == "production")
                  ...
                  res.status(200).json({
                    ...
                    authenticated: obj.data.authenticated,
                    token_type: obj.data.token_type,
                    activation_code: obj.data.activation_code
                  });
              } else {
                res.status(200).json({
                  access_token: obj.data.access_token,
...
exports.register = [
  (req, res, next) => {
    ...
    if (!errors.isEmpty()) {
      ...
      broker
        .sendRPCMessage({ body: req.body, clientId: req.clientId }, "register")
        .then(result => {
          var obj = JSON.parse(result.toString("utf8"));
          if (!obj.success) {
            if (obj.error) {
...
exports.changeavatar = [
  ...
  (req, res, next) => {
    ...
    if (!errors.isEmpty()) {
      ...
      broker
        .sendRPCMessage(
          { body: { id: req.body.id, avatar: req.file } },
          "changeavatar"
        )
        .then(result => {
          var obj = JSON.parse(result.toString("utf8"));
...
exports.updateprofile = [
  ...
  (req, res, next) => {
    ...
    if (!errors.isEmpty()) {
      ...
      broker
        .sendRPCMessage({ body: req.body }, "updateprofile")
        .then(result => {
          var obj = JSON.parse(result.toString("utf8"));
          if (!obj.success) {
            if (obj.error) return res.status(500).json(obj);
...
exports.changelanguage = [
  ...
  (req, res, next) => {
    ...
    if (!errors.isEmpty()) {
      ...
      broker
        .sendRPCMessage({ body: req.body }, "changelanguage")
        .then(result => {
          var obj = JSON.parse(result.toString("utf8"));
          if (!obj.success) {
            if (obj.error) return res.status(500).json(obj);
...
exports.changenotification = [
  ...
  (req, res, next) => {
    ...
    if (!errors.isEmpty()) {
      ...
      broker
        .sendRPCMessage({ body: req.body }, "changenotification")
        .then(result => {
          var obj = JSON.parse(result.toString("utf8"));
          if (!obj.success) {
            if (obj.error) return res.status(500).json(obj);
...
exports.deleteaccount = [
  ...
  (req, res, next) => {
    ...
    if (!errors.isEmpty()) {
      ...
      broker
        .sendRPCMessage({ body: req.body }, "deleteaccount")
        .then(result => {
          var obj = JSON.parse(result.toString("utf8"));
          if (!obj.success) {
            if (obj.error) return res.status(500).json(obj);
...
exports.locationchanged = [
  ...
  (req, res, next) => {
    ...
    if (!errors.isEmpty()) {
      ...
      broker
        .sendRPCMessage({ body: req.body }, "locationchanged")
        .then(result => {
          var obj = JSON.parse(result.toString("utf8"));
          if (!obj.success) {
            if (obj.error) return res.status(500).json(obj);
